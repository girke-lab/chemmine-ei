...
#define SWIGTYPE_p_Descriptors swig_types[1]
...
R_swig_Descriptors_get_descriptor ( SEXP self, SEXP i, SEXP s_swig_copy)
{
  ...
  arg1 = reinterpret_cast< Descriptors * >(argp1);
  arg2 = static_cast< unsigned int >(REAL(i)[0]);
...
SWIGEXPORT SEXP
R_swig_batch_parse ( SEXP sdfile, SEXP dbfile, SEXP s_swig_copy)
{
  char *arg1 = (char *) 0 ;
  char *arg2 = (char *) 0 ;
  int result;
  ...
  res1 = SWIG_AsCharPtrAndSize(sdfile, &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "batch_parse" "', argument " "1"" of type '" "char const *""'");
  }
  arg1 = reinterpret_cast< char * >(buf1);
  res2 = SWIG_AsCharPtrAndSize(dbfile, &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "batch_parse" "', argument " "2"" of type '" "char const *""'");
  }
  arg2 = reinterpret_cast< char * >(buf2);
  result = (int)batch_parse((char const *)arg1,(char const *)arg2);
  r_ans = Rf_ScalarInteger(result);
...
R_swig_new_Database ( )
{
  ...
  r_ans = SWIG_R_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_Database, R_SWIG_OWNER |  0 );
  vmaxset(r_vmax);
  if(r_nprotect)  Rf_unprotect(r_nprotect);
...
SWIGEXPORT SEXP
R_swig_Database_open ( SEXP self, SEXP filename, SEXP mode, SEXP s_swig_copy)
{
  ...
  res1 = SWIG_R_ConvertPtr(self, &argp1, SWIGTYPE_p_Database, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  arg2 = reinterpret_cast< char * >(buf2);
  arg3 = static_cast< char >(CHAR(STRING_ELT(mode, 0))[0]);
...
SWIGEXPORT SEXP
R_swig_Database_close ( SEXP self)
{
  Database *arg1 = (Database *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_R_ConvertPtr(self, &argp1, SWIGTYPE_p_Database, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Database_close" "', argument " "1"" of type '" "Database *""'"); 
  }
  arg1 = reinterpret_cast< Database * >(argp1);
  (arg1)->close();
  r_ans = R_NilValue;
...
SWIGEXPORT SEXP
R_swig_Database_next ( SEXP self, SEXP s_swig_copy)
{
  Database *arg1 = (Database *) 0 ;
  Descriptors result;
  void *argp1 = 0 ;
  ...
  res1 = SWIG_R_ConvertPtr(self, &argp1, SWIGTYPE_p_Database, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Database_next" "', argument " "1"" of type '" "Database *""'"); 
  }
  arg1 = reinterpret_cast< Database * >(argp1);
  result = (arg1)->next();
  r_ans = SWIG_R_NewPointerObj((new Descriptors(static_cast< const Descriptors& >(result))), SWIGTYPE_p_Descriptors, SWIG_POINTER_OWN |  0 );
...
SWIGEXPORT SEXP
R_swig_Database_store ( SEXP self, SEXP d, SEXP s_swig_copy)
{
  Database *arg1 = (Database *) 0 ;
  Descriptors *arg2 = 0 ;
  int result;
  ...
  res1 = SWIG_R_ConvertPtr(self, &argp1, SWIGTYPE_p_Database, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Database_store" "', argument " "1"" of type '" "Database *""'"); 
  }
  arg1 = reinterpret_cast< Database * >(argp1);
  res2 = SWIG_R_ConvertPtr(d, &argp2, SWIGTYPE_p_Descriptors,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Database_store" "', argument " "2"" of type '" "Descriptors &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "Database_store" "', argument " "2"" of type '" "Descriptors &""'"); 
  }
  arg2 = reinterpret_cast< Descriptors * >(argp2);
  result = (int)(arg1)->store(*arg2);
  r_ans = Rf_ScalarInteger(result);
...
SWIGEXPORT SEXP
R_swig_delete_Database ( SEXP self)
{
  Database *arg1 = (Database *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_R_ConvertPtr(self, &argp1, SWIGTYPE_p_Database, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN R_CallMethodDef CallEntries[] = {
   ...
   {"R_swig_Database_store", (DL_FUNC) &R_swig_Database_store, 3},
   ...
   {"R_swig_batch_parse", (DL_FUNC) &R_swig_batch_parse, 3},
   ...
   {"R_swig_Database_next", (DL_FUNC) &R_swig_Database_next, 2},
   {"R_swig_Database_open", (DL_FUNC) &R_swig_Database_open, 4},
   {"R_swig_Database_close", (DL_FUNC) &R_swig_Database_close, 1},
   {"R_swig_new_Database", (DL_FUNC) &R_swig_new_Database, 0},
   {"R_swig_delete_Database", (DL_FUNC) &R_swig_delete_Database, 1},
   {NULL, NULL, 0}
};

extern "C" SWIGEXPORT void R_init_ChemmineRpp(DllInfo *dll) {
